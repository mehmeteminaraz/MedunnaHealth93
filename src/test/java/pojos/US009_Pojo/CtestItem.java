...
public class CtestItem {
    ...
    public CtestItem(String createdBy, String createdDate, String defaultValMax, String defaultValMin, String description, Integer id, String name, Integer price) {
        super();
