...
public class Physician {
    ...
    public Physician(String adress, List<String> appointments, String birthDate, String bloodGroup, Country country, String createdBy, String createdDate, Cstate cstate, String description, Integer examFee, String firstName, String gender, Integer id, String image, String imageContentType, String lastName, String phone, String speciality, String ssn, User user) {
        super();
        this.adress = adress;
